...
class CopelandTestingController extends Controller
{
    ...
    // }
    public function copelandTest(PrometheeController $prometheeController)
    {
        $copeland = new CopelandAggregator();

        // mahasiswa
        $copeland->alternatives[] = $prometheeController->tesHitungMahasiswa();
        // dd($copeland->alternatives[0]);

        // dosen
        $copeland->alternatives[] = $prometheeController->tesHitungDosen();

        // tendik
        $copeland->alternatives[] = $prometheeController->tesHitungTendik();
