<div class="bg-white rounded-lg shadow-lg max-w-xl w-full p-6 relative border-t border-blue-700">
    ...
    <h2 class="text-xl font-semibold mb-2 text-center">Hapus Data Kategori</h2>
    <div class="w-[195px] h-1 bg-red-400 mx-auto mt-1 mb-6 rounded"></div>
    <div class="p-4 md:p-5 text-center">
        ...
        <h3 class="mb-5 text-lg font-semibold text-gray-700">Apakah Anda yakin ingin menghapus kategori ini?</h3>
