...
<div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative border-t border-blue-700">
    ...
    <h2 class="text-xl font-semibold mb-2 text-center">Tambah Data Kategori</h2>
    <div class="w-[205px] h-1 bg-yellow-400 mx-auto mt-1 mb-6 rounded"></div>

    <form id="form-tambah-kategori" action="{{ route('admin.kategori.store') }}" method="POST" class="grid grid-cols-1 gap-4" enctype="multipart/form-data">
        @csrf

        <div class="mt-1">
            <label class="block text-sm font-medium mb-1">Kode Kategori<span class="text-red-500">*</span></label>
            <input type="text" name="kode_kategori" id="kode_kategori" class="w-full border rounded-md px-3 py-2 text-sm" placeholder="Kode" required>
        ...
        <div>
            ...
            <input type="text" name="nama_kategori" id="nama_kategori" class="w-full border rounded-md px-3 py-2 text-sm" placeholder="Nama" required>
