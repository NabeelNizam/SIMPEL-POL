<div class="bg-white rounded-lg shadow-lg w-[400px] p-5 relative">
    ...
    <div class="space-y-4 mt-4 text-sm text-gray-700">
      <div>
        ...
        <input type="text" placeholder="Contoh: Gedung Sipil" class="w-full mt-1 px-3 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-400">
      </div>

      <div>
        <label class="font-medium">Lantai dan Ruangan <span class="text-red-500">*</span></label>
        <input id="inputLantai" type="text" placeholder="Input nomor lantai manual" class="w-full mt-1 px-3 py-2 border rounded-md focus:outline-none focus:ring focus:ring-blue-400">
        <button onclick="tambahLantai()" type="button" class="mt-2 w-full bg-blue-600 text-white py-2 rounded-md hover:bg-blue-700 flex items-center justify-center gap-2">
