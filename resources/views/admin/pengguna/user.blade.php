    ...
    <div class="bg-white rounded-lg shadow p-6 border-t-4 border-blue-600">
        <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex gap-2">
                ...
                <button onclick="modalAction('{{ route('admin.create_ajax') }}')"
        ...
        <div class="mb-4">
            <div class="flex flex-wrap items-end justify-between gap-4">
                <div class="flex flex-wrap items-end gap-4">
                    <div>
                        <label for="id_role" class="block text-sm font-medium text-gray-700 mb-1">Filter Berdasarkan
                            Role:</label>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" id="table-search"
                            class="block w-full pl-10 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                ...
                <table id="table_user" class="min-w-full border border-gray-300">
                    <thead>
                        <tr class="bg-white-50 border-b border-gray-200 text-black-500">
                            <th
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border border-black-300">
                                ID</th>
                            <th
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border border-black-300">
                                Nama</th>
    ...
    `;
            ...
            $(document).ready(function() {
                ...
                dataUser.on('draw', function() {
                    ...
                    $('#custom-length-menu select')
                        .attr('class',
                            'px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-white text-gray-700'
                            );
                    ...
                    $('#table_user_paginate a')
                        .attr('class',
                            'px-3 py-1 border border-gray-300 rounded-md text-sm bg-white text-blue-600 hover:bg-blue-50 transition'
                            );

                    $('#table_user_paginate span.current')
                        .attr('class',
                            'px-3 py-1 rounded-md text-sm bg-blue-600 text-white border border-blue-600');
