<nav class="bg-white border-gray-200 fixed top-0 left-0 right-0 z-50 shadow-sm">
  ...
  <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
      <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Logo SIMPEL-POL" />
      <span class="self-center text-2xl font-semibold whitespace-nowrap text-gray-900">SIMPEL-POL</span>
  </a>
