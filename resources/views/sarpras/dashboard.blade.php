...
<div class="min-h-screen bg-gray-50">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6" name="laporan">
        ...
        <div class="bg-white rounded-lg shadow border border-gray-200 p-4">
            ...
            <p class="text-xs text-gray-400 mt-1">{{ $totalLaporan > 0 ? $totalLaporan . ' laporan baru minggu ini' : 'Tidak ada laporan baru minggu ini' }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow border-l-4 border-yellow-400 p-4">
            ...
            <p class="text-xs text-gray-400 mt-1">{{ $tertunda > 0 ? $tertunda . ' menunggu lebih dari 48 jam' : 'Tidak ada laporan tertunda' }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow border-l-4 border-blue-500 p-4">
            ...
            <p class="text-xs text-gray-400 mt-1">{{ $dalamProses > 0 ? $dalamProses . ' diperbaiki hari ini' : 'Tidak ada laporan dalam proses' }}</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow border-l-4 border-green-500 p-4">
            ...
            <p class="text-xs text-gray-400 mt-1">{{ $selesai > 0 ? $selesai . ' diselesaikan dalam 24 jam terakhir' : 'Tidak ada laporan selesai' }}</p>
        </div>
    </div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900">SOP Untuk Pihak Sarana Prasarana</div>
                                        </div>
                                    </div>
                                    <div class="flex-shrink-0">
...
<script>
        ...
        const umpanBalikChart = new Chart(umpanBalikCtx, {
            type: 'bar',
            data: {
                labels: ['Sangat Puas (5)','Puas (4)','Cukup Puas (3)','Kurang Puas (2)','Tidak Puas (1)'  ],
                datasets: [{
        ...
        responsive: true,
        plugins: {
            legend: { display: true } // Menampilkan label "Jumlah Pelapor"
        },
        scales: {
            x: {
                title: {
