                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        ...
                        <div id="content-penjelasan" class="tab-content">
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                <div class="flex items-start">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-blue-800">Tentang SOP Teknisi</h3>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="prose max-w-none text-gray-700">
                                <p class="mb-4">
                                    SOP Teknisi adalah panduan prosedur standar untuk pengelolaan, pemeliharaan,
                        ...
                        <div id="content-dokumen" class="tab-content hidden">
                            <p class="text-gray-600 mb-4">Berikut adalah daftar dokumen SOP Teknisi yang dapat
                                diunduh:</p>
