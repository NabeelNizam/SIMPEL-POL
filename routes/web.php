...
Route::group(['prefix' => 'admin', 'middleware' => ['authorize:ADMIN']], function () {
    ...
    Route::get('/import', [AdminController::class, 'import_ajax'])->name('admin.import_ajax');
    ...
    Route::post('/{id}/edit_ajax', [AdminController::class, 'updated_ajax'])->name('admin.update_ajax');
